...
async function main() {
  ...
  const tags = [
    // VIEW 카테고리 (4개)
    { name: '#논뷰맛집', category: TagCategory.VIEW, icon: '🌾', description: '논이 보이는 전망 좋은 숙소', color: 'green' },
    { name: '#계곡앞', category: TagCategory.VIEW, icon: '💧', description: '계곡 바로 앞 시원한 숙소', color: 'blue' },
    { name: '#바다뷰', category: TagCategory.VIEW, icon: '🌊', description: '탁 트인 바다 전망', color: 'blue' },
    { name: '#산속힐링', category: TagCategory.VIEW, icon: '⛰️', description: '산 속 깊은 곳의 평화로운 공간', color: 'green' },

    // ACTIVITY 카테고리 (4개)
    { name: '#불멍과별멍', category: TagCategory.ACTIVITY, icon: '🔥', description: '모닥불과 별 보기', color: 'orange' },
    { name: '#아궁이체험', category: TagCategory.ACTIVITY, icon: '🪵', description: '직접 불 때보는 전통 아궁이', color: 'red' },
    { name: '#농사체험', category: TagCategory.ACTIVITY, icon: '🌱', description: '직접 농작물 수확 체험', color: 'green' },
    { name: '#낚시', category: TagCategory.ACTIVITY, icon: '🎣', description: '낚시 가능한 숙소', color: 'blue' },

    // FACILITY 카테고리 (4개)
    { name: '#반려동물동반', category: TagCategory.FACILITY, icon: '🐕', description: '반려동물과 함께 머물 수 있는 숙소', color: 'yellow' },
    { name: '#전통가옥', category: TagCategory.FACILITY, icon: '🏠', description: '한옥 등 전통 건축물', color: 'brown' },
    { name: '#독채사용', category: TagCategory.FACILITY, icon: '🏡', description: '단독 건물 전체 사용', color: 'purple' },
    { name: '#바비큐가능', category: TagCategory.FACILITY, icon: '🍖', description: 'BBQ 그릴 시설 완비', color: 'red' },

    // VIBE 카테고리 (4개)
    { name: '#힐링', category: TagCategory.VIBE, icon: '🧘', description: '조용하고 평화로운 분위기', color: 'green' },
    { name: '#가족여행', category: TagCategory.VIBE, icon: '👨‍👩‍👧‍👦', description: '온 가족이 즐기기 좋은 숙소', color: 'blue' },
    { name: '#커플추천', category: TagCategory.VIBE, icon: '💑', description: '로맨틱한 분위기', color: 'pink' },
    { name: '#SNS핫플', category: TagCategory.VIBE, icon: '📸', description: '인스타그램에 올리기 좋은 숙소', color: 'purple' },
  ];
  ...
  // 2. 테스트용 호스트 프로필 생성 (Property 시드를 위해)
  ...
  const properties = [
    {
      name: '논뷰 한옥스테이',
      description: '시원한 논밭 전망과 함께 전통 한옥의 아름다움을 느낄 수 있는 특별한 공간입니다. 도심 속 바쁜 일상에서 벗어나 자연의 소리와 함께 힐링하세요.',
    ...
    {
      name: '계곡 앞 통나무집',
      description: '맑은 계곡물 소리를 들으며 하루를 시작하는 특별한 경험. 여름엔 시원하게, 겨울엔 포근하게 머물 수 있는 통나무집입니다.',
