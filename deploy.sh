...
gcloud run deploy $SERVICE_NAME \
  ...
  --update-env-vars="NEXT_PUBLIC_SUPABASE_URL=https://xfchchvhwciaiwefgjgsg.supabase.co,NEXT_PUBLIC_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhmY2hjdmh3Y2lhaXdlZmpnanNnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI3Mzc5MjcsImV4cCI6MjA3ODMxMzkyN30.gfQFoqqBRowyI2FsR8Uu00Jt3cN2lofwleJ_J_-ctTI,NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY=pk_test_ZXRoaWNhbC1zd2lmdC0xLmNsZXJrLmFjY291bnRzLmRldiQ,CLERK_SECRET_KEY=sk_test_QGq3SR7xnY2fjnzeZhVVhUqOovPKfPgzYurXtJqfNV,NEXT_PUBLIC_CLERK_SIGN_IN_URL=/login,NEXT_PUBLIC_CLERK_SIGN_UP_URL=/signup,NEXT_PUBLIC_TOSS_CLIENT_KEY=test_ck_D5GePWvyJnrK0W0k6q8gLzN97Eoq,TOSS_SECRET_KEY=test_sk_zXLkKEypNArWmo50nX3lmeaxYG5R,GEMINI_API_KEY=AIzaSyDMtwOnB77EYK9d_eaETnSSpC25Eiu7wa0,KAKAO_CLIENT_ID=83022bf07d136c31285491b85c6ee6aa,KAKAO_CLIENT_SECRET=A0PIZLG3vhO9CmS5J1hsgu9T0LhRnWSS,KAKAO_ALIMTALK_ENABLED=false,DATABASE_URL=$DATABASE_URL" \
  --port 8080 \
  --memory 1Gi \
  --cpu 1 \
  --min-instances 0 \
