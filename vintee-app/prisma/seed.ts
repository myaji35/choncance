  ...
  const properties = [
    {
      ...
      maxGuests: 6,
      phone: "010-1234-5678",
      thumbnailUrl: "https://images.unsplash.com/photo-1601762603339-fd61e28b698a?w=1200&q=80&auto=format&fit=crop",
      hostId: host.id,
      checkinTime: "15:00",
      checkoutTime: "11:00",
      highlights: JSON.stringify(["논뷰 전망", "바비큐 가능", "온돌 체험", "전통 한옥"]),
      nearbyAttractions: JSON.stringify([
        { name: "현충사", distance: "차로 15분", latitude: 36.7816, longitude: 127.0177 },
        { name: "아산온천", distance: "차로 10분", latitude: 36.7826, longitude: 127.0014 },
      ]),
      bestSeason: "사계절",
    ...
    },
    {
      ...
      maxGuests: 4,
      phone: "010-2345-6789",
      thumbnailUrl: "https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=1200&q=80&auto=format&fit=crop",
      hostId: host.id,
      checkinTime: "16:00",
      checkoutTime: "11:00",
      highlights: JSON.stringify(["별 관측", "트레킹 코스", "벽난로"]),
      nearbyAttractions: JSON.stringify([
        { name: "오대산 국립공원", distance: "차로 20분", latitude: 37.7918, longitude: 128.5500 },
        { name: "월정사", distance: "차로 25분", latitude: 37.7313, longitude: 128.5923 },
      ]),
      bestSeason: "봄/가을",
    ...
    },
    {
      ...
      maxGuests: 5,
      thumbnailUrl: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200&q=80&auto=format&fit=crop",
      hostId: host2.id,
      checkinTime: "15:00",
      checkoutTime: "10:00",
      highlights: JSON.stringify(["오션뷰", "해산물 조식", "테라스"]),
      nearbyAttractions: JSON.stringify([
        { name: "동피랑 벽화마을", distance: "차로 15분", latitude: 34.8452, longitude: 128.4239 },
        { name: "통영 케이블카", distance: "차로 20분", latitude: 34.8308, longitude: 128.4369 },
      ]),
      bestSeason: "여름",
    ...
    },
    {
      ...
      maxGuests: 4,
      thumbnailUrl: "https://images.unsplash.com/photo-1523217582562-09d0def993a6?w=1200&q=80&auto=format&fit=crop",
      hostId: host2.id,
      checkinTime: "15:00",
      checkoutTime: "11:00",
      highlights: JSON.stringify(["감귤 농장", "독채", "프라이빗 마당", "제주 전통식"]),
      nearbyAttractions: JSON.stringify([
        { name: "쇠소깍", distance: "차로 10분", latitude: 33.2530, longitude: 126.6317 },
        { name: "정방폭포", distance: "차로 15분", latitude: 33.2447, longitude: 126.5727 },
      ]),
      bestSeason: "가을",
    ...
    },
    {
      ...
      maxGuests: 3,
      phone: "010-3456-7890",
      thumbnailUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200&q=80&auto=format&fit=crop",
      hostId: host.id,
      checkinTime: "15:00",
      checkoutTime: "11:00",
      highlights: JSON.stringify(["대나무 숲", "글램핑", "바비큐"]),
      nearbyAttractions: JSON.stringify([
        { name: "죽녹원", distance: "도보 5분", latitude: 35.3239, longitude: 126.9886 },
        { name: "메타세콰이어 길", distance: "차로 10분", latitude: 35.3399, longitude: 126.9990 },
      ]),
      bestSeason: "봄/가을",
